...
async function getSinaliteConfig() {
  let clientId = process.env.SINALITE_CLIENT_ID || "";
  let clientSecret = process.env.SINALITE_CLIENT_SECRET || "";
  let useLiveApi = process.env.SINALITE_USE_LIVE === "true";
  let customUrl = process.env.SINALITE_API_URL || "";
